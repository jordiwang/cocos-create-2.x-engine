...
static bool js_gfx_GraphicsHandle_getHandle(se::State &s, se::ScriptEngine *inst)
{
...
static bool js_gfx_GraphicsHandle_constructor(se::State &s, se::ScriptEngine *inst)
{
...
static bool js_cocos2d_renderer_GraphicsHandle_finalize(se::State &s, se::ScriptEngine *inst)
{
...
bool js_register_gfx_GraphicsHandle(se::ScriptEngine *inst, se::Object* obj)
{
    auto cls = se::Class::create(inst, "GraphicsHandle", obj, nullptr, _SE(js_gfx_GraphicsHandle_constructor));

    cls->defineFunction(inst, "getHandle", _SE(js_gfx_GraphicsHandle_getHandle));
    cls->defineFinalizeFunction(_SE(js_cocos2d_renderer_GraphicsHandle_finalize));
    cls->install(inst);
    inst->registerClass<cocos2d::renderer::GraphicsHandle>(cls);
...
static bool js_gfx_IndexBuffer_getUsage(se::State &s, se::ScriptEngine *inst)
{
...
static bool js_gfx_IndexBuffer_setFormat(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::IndexBuffer* cobj = (cocos2d::renderer::IndexBuffer*)s.nativeThisObject();
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(inst, args[0], &tmp); arg0 = (cocos2d::renderer::IndexFormat)tmp; } while(false);
...
static bool js_gfx_IndexBuffer_setCount(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::IndexBuffer* cobj = (cocos2d::renderer::IndexBuffer*)s.nativeThisObject();
...
static bool js_gfx_IndexBuffer_destroy(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::IndexBuffer* cobj = (cocos2d::renderer::IndexBuffer*)s.nativeThisObject();
...
static bool js_gfx_IndexBuffer_setUsage(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::IndexBuffer* cobj = (cocos2d::renderer::IndexBuffer*)s.nativeThisObject();
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(inst, args[0], &tmp); arg0 = (cocos2d::renderer::Usage)tmp; } while(false);
...
static bool js_gfx_IndexBuffer_getCount(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::IndexBuffer* cobj = (cocos2d::renderer::IndexBuffer*)s.nativeThisObject();
...
static bool js_gfx_IndexBuffer_setBytesPerIndex(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::IndexBuffer* cobj = (cocos2d::renderer::IndexBuffer*)s.nativeThisObject();
...
static bool js_gfx_IndexBuffer_getBytes(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::IndexBuffer* cobj = (cocos2d::renderer::IndexBuffer*)s.nativeThisObject();
...
static bool js_gfx_IndexBuffer_constructor(se::State &s, se::ScriptEngine *inst)
{
...
static bool js_cocos2d_renderer_IndexBuffer_finalize(se::State &s, se::ScriptEngine *inst)
{
...
bool js_register_gfx_IndexBuffer(se::ScriptEngine *inst, se::Object* obj)
{
    auto cls = se::Class::create(inst, "IndexBuffer", obj, __jsb_cocos2d_renderer_GraphicsHandle_proto, _SE(js_gfx_IndexBuffer_constructor));

    cls->defineFunction(inst, "getUsage", _SE(js_gfx_IndexBuffer_getUsage));
    cls->defineFunction(inst, "setFormat", _SE(js_gfx_IndexBuffer_setFormat));
    cls->defineFunction(inst, "setCount", _SE(js_gfx_IndexBuffer_setCount));
    cls->defineFunction(inst, "destroy", _SE(js_gfx_IndexBuffer_destroy));
    cls->defineFunction(inst, "setUsage", _SE(js_gfx_IndexBuffer_setUsage));
    cls->defineFunction(inst, "getCount", _SE(js_gfx_IndexBuffer_getCount));
    cls->defineFunction(inst, "setBytesPerIndex", _SE(js_gfx_IndexBuffer_setBytesPerIndex));
    cls->defineFunction(inst, "getBytes", _SE(js_gfx_IndexBuffer_getBytes));
    cls->defineFinalizeFunction(_SE(js_cocos2d_renderer_IndexBuffer_finalize));
    cls->install(inst);
    inst->registerClass<cocos2d::renderer::IndexBuffer>(cls);
...
static bool js_gfx_VertexBuffer_getUsage(se::State &s, se::ScriptEngine *inst)
{
...
static bool js_gfx_VertexBuffer_setCount(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::VertexBuffer* cobj = (cocos2d::renderer::VertexBuffer*)s.nativeThisObject();
...
static bool js_gfx_VertexBuffer_destroy(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::VertexBuffer* cobj = (cocos2d::renderer::VertexBuffer*)s.nativeThisObject();
...
static bool js_gfx_VertexBuffer_setUsage(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::VertexBuffer* cobj = (cocos2d::renderer::VertexBuffer*)s.nativeThisObject();
...
static bool js_gfx_VertexBuffer_getCount(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::VertexBuffer* cobj = (cocos2d::renderer::VertexBuffer*)s.nativeThisObject();
...
static bool js_gfx_VertexBuffer_getBytes(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::VertexBuffer* cobj = (cocos2d::renderer::VertexBuffer*)s.nativeThisObject();
...
static bool js_gfx_VertexBuffer_constructor(se::State &s, se::ScriptEngine *inst)
{
...
static bool js_cocos2d_renderer_VertexBuffer_finalize(se::State &s, se::ScriptEngine *inst)
{
...
bool js_register_gfx_VertexBuffer(se::ScriptEngine *inst, se::Object* obj)
{
    auto cls = se::Class::create(inst, "VertexBuffer", obj, __jsb_cocos2d_renderer_GraphicsHandle_proto, _SE(js_gfx_VertexBuffer_constructor));

    cls->defineFunction(inst, "getUsage", _SE(js_gfx_VertexBuffer_getUsage));
    cls->defineFunction(inst, "setCount", _SE(js_gfx_VertexBuffer_setCount));
    cls->defineFunction(inst, "destroy", _SE(js_gfx_VertexBuffer_destroy));
    cls->defineFunction(inst, "setUsage", _SE(js_gfx_VertexBuffer_setUsage));
    cls->defineFunction(inst, "getCount", _SE(js_gfx_VertexBuffer_getCount));
    cls->defineFunction(inst, "getBytes", _SE(js_gfx_VertexBuffer_getBytes));
    cls->defineFinalizeFunction(_SE(js_cocos2d_renderer_VertexBuffer_finalize));
    cls->install(inst);
    inst->registerClass<cocos2d::renderer::VertexBuffer>(cls);
...
static bool js_gfx_DeviceGraphics_setBlendFuncSeparate(se::State &s, se::ScriptEngine *inst)
{
    ...
    if (argc == 4) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(inst, args[0], &tmp); arg0 = (cocos2d::renderer::BlendFactor)tmp; } while(false);
        do { int32_t tmp = 0; ok &= seval_to_int32(inst, args[1], &tmp); arg1 = (cocos2d::renderer::BlendFactor)tmp; } while(false);
...
static bool js_gfx_DeviceGraphics_enableBlend(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
...
static bool js_gfx_DeviceGraphics_setPrimitiveType(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(inst, args[0], &tmp); arg0 = (cocos2d::renderer::PrimitiveType)tmp; } while(false);
...
static bool js_gfx_DeviceGraphics_setBlendEquationSeparate(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
    ...
    if (argc == 2) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(inst, args[0], &tmp); arg0 = (cocos2d::renderer::BlendOp)tmp; } while(false);
...
static bool js_gfx_DeviceGraphics_setIndexBuffer(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
...
static bool js_gfx_DeviceGraphics_setProgram(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
...
static bool js_gfx_DeviceGraphics_setFrameBuffer(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
...
static bool js_gfx_DeviceGraphics_setStencilFunc(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
    ...
    if (argc == 3) {
        ...
        ok &= seval_to_uint32(inst, args[2], (uint32_t*)&arg2);
...
static bool js_gfx_DeviceGraphics_setBlendColor(se::State &s, se::ScriptEngine *inst)
{
    CC_UNUSED bool ok = true;
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
...
static bool js_gfx_DeviceGraphics_setScissor(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
...
static bool js_gfx_DeviceGraphics_setVertexBuffer(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
...
static bool js_gfx_DeviceGraphics_enableDepthWrite(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
...
static bool js_gfx_DeviceGraphics_getCapacity(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
...
static bool js_gfx_DeviceGraphics_setStencilOpBack(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
    ...
    if (argc == 4) {
        ...
        unsigned int arg3 = 0;
        do { int32_t tmp = 0; ok &= seval_to_int32(inst, args[0], &tmp); arg0 = (cocos2d::renderer::StencilOp)tmp; } while(false);
        do { int32_t tmp = 0; ok &= seval_to_int32(inst, args[1], &tmp); arg1 = (cocos2d::renderer::StencilOp)tmp; } while(false);
        do { int32_t tmp = 0; ok &= seval_to_int32(inst, args[2], &tmp); arg2 = (cocos2d::renderer::StencilOp)tmp; } while(false);
        ok &= seval_to_uint32(inst, args[3], (uint32_t*)&arg3);
...
static bool js_gfx_DeviceGraphics_setViewport(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
...
static bool js_gfx_DeviceGraphics_draw(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
...
static bool js_gfx_DeviceGraphics_setDepthFunc(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
...
static bool js_gfx_DeviceGraphics_enableDepthTest(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
...
static bool js_gfx_DeviceGraphics_resetDrawCalls(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
...
static bool js_gfx_DeviceGraphics_getDrawCalls(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
...
static bool js_gfx_DeviceGraphics_setBlendEquation(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
...
static bool js_gfx_DeviceGraphics_setStencilFuncFront(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
...
static bool js_gfx_DeviceGraphics_setStencilOpFront(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
...
static bool js_gfx_DeviceGraphics_setStencilFuncBack(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
...
static bool js_gfx_DeviceGraphics_setBlendFunc(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
...
static bool js_gfx_DeviceGraphics_setCullMode(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
...
static bool js_gfx_DeviceGraphics_setStencilOp(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
...
static bool js_gfx_DeviceGraphics_enableStencilTest(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::DeviceGraphics* cobj = (cocos2d::renderer::DeviceGraphics*)s.nativeThisObject();
...
static bool js_gfx_DeviceGraphics_destroy(se::State &s, se::ScriptEngine *inst)
{
    const auto& args = s.args();
    size_t argc = args.size();
    if (argc == 0) {
...
static bool js_gfx_DeviceGraphics_getInstance(se::State &s, se::ScriptEngine *inst)
{
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        native_ptr_to_seval<cocos2d::renderer::DeviceGraphics>(inst, result, __jsb_cocos2d_renderer_DeviceGraphics_class, &instanceVal);
...
bool js_register_gfx_DeviceGraphics(se::ScriptEngine *inst, se::Object* obj)
{
    auto cls = se::Class::create(inst, "Device", obj, nullptr, nullptr);

    cls->defineFunction(inst, "setBlendFuncSep", _SE(js_gfx_DeviceGraphics_setBlendFuncSeparate));
    cls->defineFunction(inst, "enableBlend", _SE(js_gfx_DeviceGraphics_enableBlend));
    cls->defineFunction(inst, "setPrimitiveType", _SE(js_gfx_DeviceGraphics_setPrimitiveType));
    cls->defineFunction(inst, "setBlendEqSep", _SE(js_gfx_DeviceGraphics_setBlendEquationSeparate));
    cls->defineFunction(inst, "setIndexBuffer", _SE(js_gfx_DeviceGraphics_setIndexBuffer));
    cls->defineFunction(inst, "setProgram", _SE(js_gfx_DeviceGraphics_setProgram));
    cls->defineFunction(inst, "setFrameBuffer", _SE(js_gfx_DeviceGraphics_setFrameBuffer));
    cls->defineFunction(inst, "setStencilFunc", _SE(js_gfx_DeviceGraphics_setStencilFunc));
    cls->defineFunction(inst, "setBlendColor", _SE(js_gfx_DeviceGraphics_setBlendColor));
    cls->defineFunction(inst, "setScissor", _SE(js_gfx_DeviceGraphics_setScissor));
    cls->defineFunction(inst, "setVertexBuffer", _SE(js_gfx_DeviceGraphics_setVertexBuffer));
    cls->defineFunction(inst, "enableDepthWrite", _SE(js_gfx_DeviceGraphics_enableDepthWrite));
    cls->defineFunction(inst, "getCapacity", _SE(js_gfx_DeviceGraphics_getCapacity));
    cls->defineFunction(inst, "setStencilOpBack", _SE(js_gfx_DeviceGraphics_setStencilOpBack));
    cls->defineFunction(inst, "setViewport", _SE(js_gfx_DeviceGraphics_setViewport));
    cls->defineFunction(inst, "draw", _SE(js_gfx_DeviceGraphics_draw));
    cls->defineFunction(inst, "setDepthFunc", _SE(js_gfx_DeviceGraphics_setDepthFunc));
    cls->defineFunction(inst, "enableDepthTest", _SE(js_gfx_DeviceGraphics_enableDepthTest));
    cls->defineFunction(inst, "resetDrawCalls", _SE(js_gfx_DeviceGraphics_resetDrawCalls));
    cls->defineFunction(inst, "getDrawCalls", _SE(js_gfx_DeviceGraphics_getDrawCalls));
    cls->defineFunction(inst, "setBlendEquation", _SE(js_gfx_DeviceGraphics_setBlendEquation));
    cls->defineFunction(inst, "setStencilFuncFront", _SE(js_gfx_DeviceGraphics_setStencilFuncFront));
    cls->defineFunction(inst, "setStencilOpFront", _SE(js_gfx_DeviceGraphics_setStencilOpFront));
    cls->defineFunction(inst, "setStencilFuncBack", _SE(js_gfx_DeviceGraphics_setStencilFuncBack));
    cls->defineFunction(inst, "setBlendFunc", _SE(js_gfx_DeviceGraphics_setBlendFunc));
    cls->defineFunction(inst, "setCullMode", _SE(js_gfx_DeviceGraphics_setCullMode));
    cls->defineFunction(inst, "setStencilOp", _SE(js_gfx_DeviceGraphics_setStencilOp));
    cls->defineFunction(inst, "enableStencilTest", _SE(js_gfx_DeviceGraphics_enableStencilTest));
    cls->defineStaticFunction(inst, "destroy", _SE(js_gfx_DeviceGraphics_destroy));
    cls->defineStaticFunction(inst, "getInstance", _SE(js_gfx_DeviceGraphics_getInstance));
    cls->install(inst);
    inst->registerClass<cocos2d::renderer::DeviceGraphics>(cls);
...
static bool js_gfx_FrameBuffer_getHeight(se::State &s, se::ScriptEngine *inst)
{
...
static bool js_gfx_FrameBuffer_getWidth(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::FrameBuffer* cobj = (cocos2d::renderer::FrameBuffer*)s.nativeThisObject();
...
static bool js_gfx_FrameBuffer_destroy(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::FrameBuffer* cobj = (cocos2d::renderer::FrameBuffer*)s.nativeThisObject();
...
static bool js_gfx_FrameBuffer_constructor(se::State &s, se::ScriptEngine *inst)
{
...
static bool js_cocos2d_renderer_FrameBuffer_finalize(se::State &s, se::ScriptEngine *inst)
{
...
bool js_register_gfx_FrameBuffer(se::ScriptEngine *inst, se::Object* obj)
{
    auto cls = se::Class::create(inst, "FrameBuffer", obj, __jsb_cocos2d_renderer_GraphicsHandle_proto, _SE(js_gfx_FrameBuffer_constructor));

    cls->defineFunction(inst, "getHeight", _SE(js_gfx_FrameBuffer_getHeight));
    cls->defineFunction(inst, "getWidth", _SE(js_gfx_FrameBuffer_getWidth));
    cls->defineFunction(inst, "destroy", _SE(js_gfx_FrameBuffer_destroy));
    cls->defineFinalizeFunction(_SE(js_cocos2d_renderer_FrameBuffer_finalize));
    cls->install(inst);
    inst->registerClass<cocos2d::renderer::FrameBuffer>(cls);
...
static bool js_cocos2d_renderer_RenderTarget_finalize(se::State &s, se::ScriptEngine *inst)
{
...
bool js_register_gfx_RenderTarget(se::ScriptEngine *inst, se::Object* obj)
{
    auto cls = se::Class::create(inst, "RenderTarget", obj, __jsb_cocos2d_renderer_GraphicsHandle_proto, nullptr);

    cls->defineFinalizeFunction(_SE(js_cocos2d_renderer_RenderTarget_finalize));
    cls->install(inst);
    inst->registerClass<cocos2d::renderer::RenderTarget>(cls);
...
static bool js_gfx_RenderBuffer_init(se::State &s, se::ScriptEngine *inst)
{
    ...
    if (argc == 4) {
        ...
        ok &= seval_to_native_ptr(inst, args[0], &arg0);
        do { int32_t tmp = 0; ok &= seval_to_int32(inst, args[1], &tmp); arg1 = (cocos2d::renderer::RenderBuffer::Format)tmp; } while(false);
        ok &= seval_to_uint16(inst, args[2], &arg2);
        ok &= seval_to_uint16(inst, args[3], &arg3);
...
static bool js_gfx_RenderBuffer_update(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::RenderBuffer* cobj = (cocos2d::renderer::RenderBuffer*)s.nativeThisObject();
    ...
    if (argc == 2) {
        ...
        ok &= seval_to_uint16(inst, args[0], &arg0);
        ok &= seval_to_uint16(inst, args[1], &arg1);
...
static bool js_gfx_RenderBuffer_create(se::State &s, se::ScriptEngine *inst)
{
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 4) {
        ...
        result->retain();
        auto obj = se::Object::createObjectWithClass(inst, __jsb_cocos2d_renderer_RenderBuffer_class);
...
static bool js_gfx_RenderBuffer_constructor(se::State &s, se::ScriptEngine *inst)
{
...
static bool js_cocos2d_renderer_RenderBuffer_finalize(se::State &s, se::ScriptEngine *inst)
{
...
bool js_register_gfx_RenderBuffer(se::ScriptEngine *inst, se::Object* obj)
{
    auto cls = se::Class::create(inst, "RenderBuffer", obj, __jsb_cocos2d_renderer_RenderTarget_proto, _SE(js_gfx_RenderBuffer_constructor));

    cls->defineFunction(inst, "init", _SE(js_gfx_RenderBuffer_init));
    cls->defineFunction(inst, "update", _SE(js_gfx_RenderBuffer_update));
    cls->defineStaticFunction(inst, "create", _SE(js_gfx_RenderBuffer_create));
    cls->defineFinalizeFunction(_SE(js_cocos2d_renderer_RenderBuffer_finalize));
    cls->install(inst);
    inst->registerClass<cocos2d::renderer::RenderBuffer>(cls);
...
static bool js_gfx_Texture_getWidth(se::State &s, se::ScriptEngine *inst)
{
    ...
    if (argc == 0) {
        ...
        ok &= int16_to_seval(inst, result, &s.rval());
...
static bool js_gfx_Texture_setAlphaAtlas(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::Texture* cobj = (cocos2d::renderer::Texture*)s.nativeThisObject();
...
static bool js_gfx_Texture_getHeight(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::Texture* cobj = (cocos2d::renderer::Texture*)s.nativeThisObject();
...
static bool js_gfx_Texture_isAlphaAtlas(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::Texture* cobj = (cocos2d::renderer::Texture*)s.nativeThisObject();
...
static bool js_gfx_Texture_getTarget(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::Texture* cobj = (cocos2d::renderer::Texture*)s.nativeThisObject();
...
static bool js_cocos2d_renderer_Texture_finalize(se::State &s, se::ScriptEngine *inst)
{
...
bool js_register_gfx_Texture(se::ScriptEngine *inst, se::Object* obj)
{
    auto cls = se::Class::create(inst, "Texture", obj, __jsb_cocos2d_renderer_RenderTarget_proto, nullptr);

    cls->defineFunction(inst, "getWidth", _SE(js_gfx_Texture_getWidth));
    cls->defineFunction(inst, "setAlphaAtlas", _SE(js_gfx_Texture_setAlphaAtlas));
    cls->defineFunction(inst, "getHeight", _SE(js_gfx_Texture_getHeight));
    cls->defineFunction(inst, "isAlphaAtlas", _SE(js_gfx_Texture_isAlphaAtlas));
    cls->defineFunction(inst, "getTarget", _SE(js_gfx_Texture_getTarget));
    cls->defineFinalizeFunction(_SE(js_cocos2d_renderer_Texture_finalize));
    cls->install(inst);
    inst->registerClass<cocos2d::renderer::Texture>(cls);
...
static bool js_gfx_Texture2D_updateImage(se::State &s, se::ScriptEngine *inst)
{
    ...
    if (argc == 1) {
        ...
        ok &= seval_to_TextureImageOption(inst, args[0], &arg0);
...
static bool js_gfx_Texture2D_init(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::Texture2D* cobj = (cocos2d::renderer::Texture2D*)s.nativeThisObject();
    ...
    if (argc == 2) {
        ...
        ok &= seval_to_native_ptr(inst, args[0], &arg0);
        ok &= seval_to_TextureOptions(inst, args[1], &arg1);
...
static bool js_gfx_Texture2D_updateSubImage(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::Texture2D* cobj = (cocos2d::renderer::Texture2D*)s.nativeThisObject();
    ...
    if (argc == 1) {
        ...
        ok &= seval_to_TextureSubImageOption(inst, args[0], &arg0);
...
static bool js_gfx_Texture2D_update(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::Texture2D* cobj = (cocos2d::renderer::Texture2D*)s.nativeThisObject();
    ...
    if (argc == 1) {
        ...
        ok &= seval_to_TextureOptions(inst, args[0], &arg0);
...
static bool js_gfx_Texture2D_constructor(se::State &s, se::ScriptEngine *inst)
{
...
static bool js_cocos2d_renderer_Texture2D_finalize(se::State &s, se::ScriptEngine *inst)
{
...
bool js_register_gfx_Texture2D(se::ScriptEngine *inst, se::Object* obj)
{
    auto cls = se::Class::create(inst, "Texture2D", obj, __jsb_cocos2d_renderer_Texture_proto, _SE(js_gfx_Texture2D_constructor));

    cls->defineFunction(inst, "updateImage", _SE(js_gfx_Texture2D_updateImage));
    cls->defineFunction(inst, "init", _SE(js_gfx_Texture2D_init));
    cls->defineFunction(inst, "updateSubImageNative", _SE(js_gfx_Texture2D_updateSubImage));
    cls->defineFunction(inst, "updateNative", _SE(js_gfx_Texture2D_update));
    cls->defineFinalizeFunction(_SE(js_cocos2d_renderer_Texture2D_finalize));
    cls->install(inst);
    inst->registerClass<cocos2d::renderer::Texture2D>(cls);
...
static bool js_gfx_Program_getID(se::State &s, se::ScriptEngine *inst)
{
...
static bool js_gfx_Program_init(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::Program* cobj = (cocos2d::renderer::Program*)s.nativeThisObject();
    ...
    if (argc == 3) {
        ...
        std::string arg2_tmp; ok &= seval_to_std_string(inst, args[2], &arg2_tmp); arg2 = arg2_tmp.c_str();
...
static bool js_gfx_Program_link(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::renderer::Program* cobj = (cocos2d::renderer::Program*)s.nativeThisObject();
...
static bool js_gfx_Program_constructor(se::State &s, se::ScriptEngine *inst)
{
...
static bool js_cocos2d_renderer_Program_finalize(se::State &s, se::ScriptEngine *inst)
{
...
bool js_register_gfx_Program(se::ScriptEngine *inst, se::Object* obj)
{
    auto cls = se::Class::create(inst, "Program", obj, __jsb_cocos2d_renderer_GraphicsHandle_proto, _SE(js_gfx_Program_constructor));

    cls->defineFunction(inst, "getID", _SE(js_gfx_Program_getID));
    cls->defineFunction(inst, "init", _SE(js_gfx_Program_init));
    cls->defineFunction(inst, "link", _SE(js_gfx_Program_link));
    cls->defineFinalizeFunction(_SE(js_cocos2d_renderer_Program_finalize));
    cls->install(inst);
    inst->registerClass<cocos2d::renderer::Program>(cls);
...
bool register_all_gfx(se::ScriptEngine *inst, se::Object* obj)
{
    // Get the ns
    se::Value nsVal;
    ...
    js_register_gfx_GraphicsHandle(inst, ns);
    js_register_gfx_RenderTarget(inst, ns);
    js_register_gfx_RenderBuffer(inst, ns);
    js_register_gfx_VertexBuffer(inst, ns);
    js_register_gfx_DeviceGraphics(inst, ns);
    js_register_gfx_Texture(inst, ns);
    js_register_gfx_Program(inst, ns);
    js_register_gfx_Texture2D(inst, ns);
    js_register_gfx_IndexBuffer(inst, ns);
    js_register_gfx_FrameBuffer(inst, ns);
    return true;
}
