...
static bool js_webview_WebView_setOnShouldStartLoading(se::State &s, se::ScriptEngine *inst)
{
        ...
        do {
            if (args[0].isObject() && args[0].toObject()->isFunction())
            {
                ...
                auto lambda = [=](cocos2d::WebView* larg0, const std::string& larg1) -> bool {
                    ...
                    se::ValueArray args;
                    args.resize(2);
                    ok &= native_ptr_to_seval<cocos2d::WebView>(inst, (cocos2d::WebView*)larg0, &args[0]);
...
static bool js_webview_WebView_setOnDidFailLoading(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::WebView* cobj = (cocos2d::WebView*)s.nativeThisObject();
...
static bool js_webview_WebView_canGoBack(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::WebView* cobj = (cocos2d::WebView*)s.nativeThisObject();
...
static bool js_webview_WebView_loadHTMLString(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::WebView* cobj = (cocos2d::WebView*)s.nativeThisObject();
...
static bool js_webview_WebView_goForward(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::WebView* cobj = (cocos2d::WebView*)s.nativeThisObject();
...
static bool js_webview_WebView_goBack(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::WebView* cobj = (cocos2d::WebView*)s.nativeThisObject();
...
static bool js_webview_WebView_setScalesPageToFit(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::WebView* cobj = (cocos2d::WebView*)s.nativeThisObject();
...
static bool js_webview_WebView_getOnDidFailLoading(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::WebView* cobj = (cocos2d::WebView*)s.nativeThisObject();
...
static bool js_webview_WebView_loadFile(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::WebView* cobj = (cocos2d::WebView*)s.nativeThisObject();
...
static bool js_webview_WebView_loadURL(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::WebView* cobj = (cocos2d::WebView*)s.nativeThisObject();
...
static bool js_webview_WebView_setBounces(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::WebView* cobj = (cocos2d::WebView*)s.nativeThisObject();
...
static bool js_webview_WebView_evaluateJS(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::WebView* cobj = (cocos2d::WebView*)s.nativeThisObject();
...
static bool js_webview_WebView_setOnJSCallback(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::WebView* cobj = (cocos2d::WebView*)s.nativeThisObject();
...
static bool js_webview_WebView_setBackgroundTransparent(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::WebView* cobj = (cocos2d::WebView*)s.nativeThisObject();
...
static bool js_webview_WebView_getOnJSCallback(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::WebView* cobj = (cocos2d::WebView*)s.nativeThisObject();
...
static bool js_webview_WebView_canGoForward(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::WebView* cobj = (cocos2d::WebView*)s.nativeThisObject();
...
static bool js_webview_WebView_getOnShouldStartLoading(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::WebView* cobj = (cocos2d::WebView*)s.nativeThisObject();
...
static bool js_webview_WebView_stopLoading(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::WebView* cobj = (cocos2d::WebView*)s.nativeThisObject();
...
static bool js_webview_WebView_setFrame(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::WebView* cobj = (cocos2d::WebView*)s.nativeThisObject();
...
static bool js_webview_WebView_setVisible(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::WebView* cobj = (cocos2d::WebView*)s.nativeThisObject();
...
static bool js_webview_WebView_reload(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::WebView* cobj = (cocos2d::WebView*)s.nativeThisObject();
...
static bool js_webview_WebView_loadData(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::WebView* cobj = (cocos2d::WebView*)s.nativeThisObject();
...
static bool js_webview_WebView_setJavascriptInterfaceScheme(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::WebView* cobj = (cocos2d::WebView*)s.nativeThisObject();
...
static bool js_webview_WebView_setOnDidFinishLoading(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::WebView* cobj = (cocos2d::WebView*)s.nativeThisObject();
...
static bool js_webview_WebView_getOnDidFinishLoading(se::State &s, se::ScriptEngine *inst)
{
    cocos2d::WebView* cobj = (cocos2d::WebView*)s.nativeThisObject();
...
static bool js_webview_WebView_create(se::State &s, se::ScriptEngine *inst)
{
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        result->retain();
        auto obj = se::Object::createObjectWithClass(inst, __jsb_cocos2d_WebView_class);
...
static bool js_webview_WebView_constructor(se::State &s, se::ScriptEngine *inst)
{
...
static bool js_cocos2d_WebView_finalize(se::State &s, se::ScriptEngine *inst)
{
...
static bool js_cocos2d_WebView_destroy(se::State &s, se::ScriptEngine *inst)
{
...
bool js_register_webview_WebView(se::ScriptEngine *inst, se::Object* obj)
{
    auto cls = se::Class::create(inst, "WebView", obj, nullptr, _SE(js_webview_WebView_constructor));

    cls->defineFunction(inst, "setOnShouldStartLoading", _SE(js_webview_WebView_setOnShouldStartLoading));
    cls->defineFunction(inst, "setOnDidFailLoading", _SE(js_webview_WebView_setOnDidFailLoading));
    cls->defineFunction(inst, "canGoBack", _SE(js_webview_WebView_canGoBack));
    cls->defineFunction(inst, "loadHTMLString", _SE(js_webview_WebView_loadHTMLString));
    cls->defineFunction(inst, "goForward", _SE(js_webview_WebView_goForward));
    cls->defineFunction(inst, "goBack", _SE(js_webview_WebView_goBack));
    cls->defineFunction(inst, "setScalesPageToFit", _SE(js_webview_WebView_setScalesPageToFit));
    cls->defineFunction(inst, "getOnDidFailLoading", _SE(js_webview_WebView_getOnDidFailLoading));
    cls->defineFunction(inst, "loadFile", _SE(js_webview_WebView_loadFile));
    cls->defineFunction(inst, "loadURL", _SE(js_webview_WebView_loadURL));
    cls->defineFunction(inst, "setBounces", _SE(js_webview_WebView_setBounces));
    cls->defineFunction(inst, "evaluateJS", _SE(js_webview_WebView_evaluateJS));
    cls->defineFunction(inst, "setOnJSCallback", _SE(js_webview_WebView_setOnJSCallback));
    cls->defineFunction(inst, "setBackgroundTransparent", _SE(js_webview_WebView_setBackgroundTransparent));
    cls->defineFunction(inst, "getOnJSCallback", _SE(js_webview_WebView_getOnJSCallback));
    cls->defineFunction(inst, "canGoForward", _SE(js_webview_WebView_canGoForward));
    cls->defineFunction(inst, "getOnShouldStartLoading", _SE(js_webview_WebView_getOnShouldStartLoading));
    cls->defineFunction(inst, "stopLoading", _SE(js_webview_WebView_stopLoading));
    cls->defineFunction(inst, "setFrame", _SE(js_webview_WebView_setFrame));
    cls->defineFunction(inst, "setVisible", _SE(js_webview_WebView_setVisible));
    cls->defineFunction(inst, "reload", _SE(js_webview_WebView_reload));
    cls->defineFunction(inst, "loadData", _SE(js_webview_WebView_loadData));
    cls->defineFunction(inst, "setJavascriptInterfaceScheme", _SE(js_webview_WebView_setJavascriptInterfaceScheme));
    cls->defineFunction(inst, "setOnDidFinishLoading", _SE(js_webview_WebView_setOnDidFinishLoading));
    cls->defineFunction(inst, "getOnDidFinishLoading", _SE(js_webview_WebView_getOnDidFinishLoading));
    cls->defineFunction(inst, "destroy", _SE(js_cocos2d_WebView_destroy));
    cls->defineStaticFunction(inst, "create", _SE(js_webview_WebView_create));
    cls->defineFinalizeFunction(_SE(js_cocos2d_WebView_finalize));
    cls->install(inst);
    inst->registerClass<cocos2d::WebView>(cls);
...
bool register_all_webview(se::ScriptEngine *inst, se::Object* obj)
{
    // Get the ns
    se::Value nsVal;
    ...
    js_register_webview_WebView(inst, ns);
    return true;
}
