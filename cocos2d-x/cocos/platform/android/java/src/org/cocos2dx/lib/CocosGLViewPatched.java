 ...
 *
 */
public class CocosGLViewPatched extends SurfaceView implements SurfaceHolder.Callback2 {
     ...
     */
    public CocosGLViewPatched(Context context) {
        super(context);
        init();
    }
     ...
     * must call {@link #setRenderer} to register a renderer.
     */
    public CocosGLViewPatched(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private static class EglHelper {
        public EglHelper(WeakReference<CocosGLViewPatched> glSurfaceViewWeakRef) {
        ...
        public void start() {
            ...
            CocosGLViewPatched view = mGLSurfaceViewWeakRef.get();
            if (view == null) {
                mEglConfig = null;
                mEglContext = null;
            } else {
...
//            return function + " failed: " + EGLLogWrapper.getErrorString(error);
        ...
        private WeakReference<CocosGLViewPatched> mGLSurfaceViewWeakRef;
        EGL10 mEgl;
...
//        @UnsupportedAppUsage
    ...
    static class GLThread extends Thread {
        GLThread(WeakReference<CocosGLViewPatched> glSurfaceViewWeakRef) {
            super();
            mWidth = 0;
            mHeight = 0;
            mRequestRender = true;
...
//        @UnsupportedAppUsage
    ...
    private final WeakReference<CocosGLViewPatched> mThisWeakRef =
            new WeakReference<CocosGLViewPatched>(this);
//    @UnsupportedAppUsage
